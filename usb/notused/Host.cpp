...
const auto NVM_USB_PAD_TRANSN_POS = 45;
const auto NVM_USB_PAD_TRANSN_SIZE = 5;
// USB TRANSP calibration value. Should be written to the USB PADCAL register.
const auto NVM_USB_PAD_TRANSP_POS = 50;
const auto NVM_USB_PAD_TRANSP_SIZE = 5;
// USB TRIM calibration value. Should be written to the USB PADCAL register.
const auto NVM_USB_PAD_TRIM_POS = 55;
const auto NVM_USB_PAD_TRIM_SIZE = 3;
...
void UHD_Init()
{
    ...
    GPIO::setFunction(GPIO::FeatherM0::UsbDm, GPIO::Function::Com);
    GPIO::setFunction(GPIO::FeatherM0::UsbDp, GPIO::Function::Com);
    ...
    */
    ...
    GPIO::setMode(GPIO::FeatherM0::UsbEn, GPIO::Mode::High);
